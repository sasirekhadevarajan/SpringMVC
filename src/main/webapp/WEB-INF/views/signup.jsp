...
<body>
     ...
     <form:form action="saveUser" method="post" modelAttribute="user">
       ...
       <div class="divformsignup" style="margin-top:10%">
	    ...
	    <form:input path="email" type="text" id="email" name="email" placeholder="Enter your email.."/><br><br>
		 
	    <label for="password">Password <span style="color:red">*</span></label><br>
	    <form:input path="password" type="password" id="password" name="password" placeholder="Enter your password.."/><br><br>
	    
	    <label for="confirmpwd">Confirm Password <span style="color:red">*</span></label><br>
	    <input type="password" id="confirmpwd" name="confirmpwd" placeholder="Confirm password.."/><br><br>
	    ...
	    <div style="margin-left:15%">
	        <input type="submit" onclick="return verifyPwdConPwdMatch();" value="Submit">
